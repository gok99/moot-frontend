...
class ChatBox2Base extends Component {
  constructor(props) {
    super(props);
    this.state = { data: { chats: { chat2: { active: false, activematchUUID: 0 } } } };
  }
  ...
  render() {
    return (
      <div className="contentbox spacedbox">
        <Row>
          <Col xs={9}>
            <p className="chatboxheader">Anonymous Chat #2:</p>
          </Col>
          <Col xs={3}>
            { this.state.data.chats.chat2.active 
        ...
        <hr />
        <p className="chatboxtext">You are currently matched with: {this.state.data.chats.chat2.activematchUUID }</p>
