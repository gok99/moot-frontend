...
class ChatBox1Base extends Component {
  constructor(props) {
    super(props);
    this.state = { data: { chat1: { active: false, activematchUUID: 0 } } };
  }
  ...
  render() {
    return (
      <div className="contentbox spacedbox">
        ...
        <hr />
        <p className="chatboxtext">You are currently matched with: {this.state.data.chat1.activematchUUID }</p>
